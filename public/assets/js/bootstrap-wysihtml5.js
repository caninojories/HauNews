    ...
    var templates = {
        ...
        "lists":       "<li>" +
                           "<div class='btn-group'>" +
                               ...
                               "<a class='btn btn-default' data-wysihtml5-command='insertOrderedList' title='Ordered List'><i class='fa fa-list-ol'></i></a>" +
                               "<a class='btn btn-default' data-wysihtml5-command='Outdent' title='Outdent'><i class='fa fa-outdent'></i></a>" +
                               "<a class='btn btn-default' data-wysihtml5-command='Indent' title='Indent'><i class='fa fa fa-indent'></i></a>" +
                           "</div>" +
                       "</li>",
        "link":        "<li>" +
